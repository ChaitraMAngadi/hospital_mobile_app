...
class _EditPatientPageState extends State<EditPatientPage> {
  ...
  void initState() {
    ...
    fetchpatient = doctorprovider.getpatient(widget.patientId).then((_) {
                      ...
                      r'^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.(com|org|net|edu|gov|in|io|co|me|info|biz|xyz)$';
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                gradient: doctorprovider.editingpatient?LinearGradient(colors: [
                              ...
                              child: ElevatedButton(
                                style:  ButtonStyle(
                                  ...
                                  backgroundColor: doctorprovider.editingpatient? const WidgetStatePropertyAll(Colors.transparent):
                                ...
                                onPressed:doctorprovider.editingpatient?null: () async {
                                  if (formkey.currentState!.validate()) {
                                    setState(() {
                                      doctorprovider.editingpatient = true;
                                    });
                                    await doctorprovider.editpatient(
                                      widget.patientId,
                                    ...
                                    await doctorprovider.getPatientsByPage(1);

                                    // patientpageprovider.notify();
                                  }
                                },
                                child:doctorprovider.editingpatient?CircularProgressIndicator(): const Text(
                                  'Edit Patient',
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 16,
