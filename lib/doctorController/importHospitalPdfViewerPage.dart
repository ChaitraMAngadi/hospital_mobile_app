...
class ImportHospitalPdfViewerPage extends StatefulWidget {
  final String complaintId;
  final String patientId;

  const ImportHospitalPdfViewerPage({
  ...
  @override
  State<ImportHospitalPdfViewerPage> createState() => _ImportHospitalPdfViewerPageState();
}

class _ImportHospitalPdfViewerPageState extends State<ImportHospitalPdfViewerPage> {
  ...
  Future<void> _loadPdfData() async {
    ...
    try {
      ...
      final String url =
          "${Constants.baseUrl}/api/v1/hospitaldoctor/getallsharedpatienthospitaldownloadpdf/${widget.patientId}/${widget.complaintId}";
          print(url);
