...
class OutvisitSupportingFilesDialogBox extends StatefulWidget {
  const OutvisitSupportingFilesDialogBox({super.key, required this.patientId, required this.complaintId});
  final String patientId;
  final String complaintId;

  @override
  State<OutvisitSupportingFilesDialogBox> createState() => _OutvisitSupportingFilesDialogBoxState();
}

class _OutvisitSupportingFilesDialogBoxState extends State<OutvisitSupportingFilesDialogBox>
              ...
              children: [
                ...
                FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return doctorprovider.outvisitsupportingfiles.isEmpty?
                      Center(child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(
                    ...
                    : GridView.builder(
                      ...
                      itemCount: doctorprovider.outvisitsupportingfiles.length,
                      itemBuilder: (context, index) {
                        final fileUrl = doctorprovider.outvisitsupportingfiles[index];
                          ...
                          Expanded(
                            child: ElevatedButton(
                              ...
                              onPressed: doctorprovider.isDeleting ? null : () async {
                                ...
                                await doctorprovider.deletesupportingfile(widget.patientId, widget.complaintId, fileUrl, context);
