...
class PatientInHistoryAi extends StatefulWidget {
  const PatientInHistoryAi({
    super.key,
  ...
  @override
  State<PatientInHistoryAi> createState() => _PatientInHistoryAiState();
}

class _PatientInHistoryAiState extends State<PatientInHistoryAi>  with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("IPD Patient AI History",
        style: TextStyle(
          color: Colors.white,
          fontWeight: FontWeight.bold,
        ),),
      ...
      body: Padding(
        ...
        child: isLoading
            ? _buildShimmerEffect()
            : patientpageprovider.inpatienthistorydata.isEmpty
                ? Column(
                  children: [
                ...
                : Column(
                  children: [
                    Expanded(
                      child: Markdown(
                          data: patientpageprovider.inpatienthistorydata.isNotEmpty
                              ? patientpageprovider.inpatienthistorydata
