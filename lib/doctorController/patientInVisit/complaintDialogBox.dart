          ...
          child: Form(
                ...
                DropdownSearch<Map<String, dynamic>>(
                  ...
                  dropdownDecoratorProps:  DropDownDecoratorProps(
                    dropdownSearchDecoration:
                        InputDecoration(hintText: "Select Duty Doctor",
                         border: OutlineInputBorder(
            ...
            return null;
                ...
                DropdownSearch<Map<String, dynamic>>(
                  ...
                  dropdownDecoratorProps:  DropDownDecoratorProps(
                    dropdownSearchDecoration:
                        InputDecoration(hintText: "Select Visiting Doctor",
                         border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12), // rounded corners
            ...
            return null;
                ...
                DropdownSearch<Map<String, dynamic>>(
                  ...
                  dropdownDecoratorProps:  DropDownDecoratorProps(
                    dropdownSearchDecoration:
                        InputDecoration(hintText: "Select Nurse",
                         border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12), // rounded corners
            ...
            SizedBox(
                ...
                debugPrint("Duty Doctor ID: ${selectedDutyDoctor?['userid']}");
                debugPrint("Visiting Doctor ID: ${selectedVisitingDoctor?['userid']}");
