...
class ViewreportPdfViewerPage extends StatefulWidget {
  final String complaintId;
  final String patientId;
  final String diagnosisId;

  const ViewreportPdfViewerPage({
  ...
  @override
  State<ViewreportPdfViewerPage> createState() => _ViewreportPdfViewerPageState();
}

class _ViewreportPdfViewerPageState extends State<ViewreportPdfViewerPage> {
  ...
  Future<void> _loadPdfData() async {
    ...
    try {
      ...
      final String url =
          "${Constants.baseUrl}/api/v1/hospitalnurse/getdownloaddetailspdf/${widget.patientId}/${widget.complaintId}/${widget.diagnosisId}";
          print(url);
  ...
  Future<void> _downloadAndPrintPdf() async {
    ...
    try {
      await Printing.layoutPdf(
        ...
        name: "${widget.patientId}_Diagnosis_Report}.pdf",
      );
    } catch (error) {
